...
const lookUptokenIdToStarInfo = async () => {
  ...
  const starInfo = await instance.lookUptokenIdToStarInfo( id );
  App.setStarInfo( starInfo );
}
...
const App = {
  start: function () {
    ...
    web3.eth.getAccounts(function (err, accs) {
      ...
      element.innerHTML = "Account : " + account;
  ...
  /**
  * 1. Function createStar, that creates a  star with name and Token ID, 
  */
  createStar: function () {
    createStar();
  },
  ...
  /**
  * 2. Function lookUptokenIdToStarInfo, that looks up the stars using the Token ID, 
